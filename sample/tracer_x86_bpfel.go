...
type tracerData struct{ Comm [16]int8 }
...
type tracerProgramSpecs struct {
	DetectSyscallEnter *ebpf.ProgramSpec `ebpf:"detect_syscall_enter"`
}
...
type tracerPrograms struct {
	DetectSyscallEnter *ebpf.Program `ebpf:"detect_syscall_enter"`
}

func (p *tracerPrograms) Close() error {
	return _TracerClose(
		p.DetectSyscallEnter,
	)
}
